public any Native_SpawnAsObserver(Handle plugin, int argc)
{
    ...
    if(hSDKCall == null)
    {
        ...
        PrepSDKCall_SetFromConf(g_pGameConfig, SDKConf_Signature, "CZP_Player::SpawnAsObserver");
        PrepSDKCall_AddParameter(SDKType_Bool, SDKPass_Plain);
        hSDKCall = EndPrepSDKCall();
        if(hSDKCall == null)
        {
            SetFailState("Failed to setup SDKCall for CZP_Player::SpawnAsObserver. Update your game data!");
            return 0;
        }
    }
